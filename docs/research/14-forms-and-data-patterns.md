...
Toasts must work across render mode boundaries (a static SSR page triggers a toast that displays in an interactive layout region). This requires a **service-based architecture** matching the dual-API pattern established for Dialog in [02-architecture.md](02-architecture.md).
